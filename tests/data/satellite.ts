...
export interface DbConfig { 'max_memory_size' : [] | [ConfigMaxMemorySize] }
export interface DelDoc { 'version' : [] | [bigint] }
export interface DelRule { 'version' : [] | [bigint] }
export interface DeleteControllersArgs { 'controllers' : Array<Principal> }
export interface DemoArg { 'status' : string, 'message' : string }
...
export interface InitUploadResult { 'batch_id' : bigint }
...
export interface UploadChunkResult { 'chunk_id' : bigint }
export interface _SERVICE {
  ...
  'demo' : ActorMethod<[DemoArg], Result>,
  'say' : ActorMethod<[], undefined>,
}
